 ...
 *      inkbrush.config.example.ts), authored against `astro-inkbrush/config` —
 *      defineInkbrushConfig and the whole config-type family live on that
 *      subpath, which a config file can import without pulling server code.
 *
