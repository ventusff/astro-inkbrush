...
Whole-file entries — a translation, an import — are listed for the record
but carry no revert button: undoing them is git's job.
...
- The result passes through the same build gate as any other save. A
